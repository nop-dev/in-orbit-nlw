			...
			<div className="flex flex-col gap-6">
				...
				<div className="flex flex-col gap-4">
					<h3 className="font-medium">
						Terça <span className="text-zinc-400 text-xs">(10 de Agosto)</span>
					</h3>
					...
					<ul className="flex flex-col gap-3">
						<li className="flex items-center gap-2">
							...
							<span className="text-sm text-zinc-400">
								...
								<span className="text-zinc-100">07:15</span>
							</span>
						</li>
					</ul>
				</div>
				...
				<div className="flex flex-col gap-4">
					<h3 className="font-medium">
						Quinta <span className="text-zinc-400 text-xs">(10 de Agosto)</span>
					</h3>
				...
				<div className="flex flex-col gap-4">
					<h3 className="font-medium">
						Sexta <span className="text-zinc-400 text-xs">(10 de Agosto)</span>
					</h3>
